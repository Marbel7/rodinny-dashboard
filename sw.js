...
const CACHE_NAME = 'rodinny-dashboard-v5';
...
self.addEventListener('fetch', function(event) {
  ...
  event.respondWith((async function() {
    try {
      ...
      // MOBILNÍ NAVIGACE: Nahraď Nastavení centrálním tlačítkem Hlasem.
      ...
      // Přesné rozložení: Přehled | Úkoly | Hlasem | Nákup | Výdaje.
      ...
      // OPRAVA SEZNAMŮ:
      // Původní addSzItem používá updateDoc. Pokud je seznam starší/neúplný
      // nebo update selže, použijeme setDoc(..., {merge:true}), zachováme
      // položky a zobrazíme skutečnou chybu místo tichého selhání.
