...
const CACHE_NAME = 'rodinny-dashboard-v25';
...
self.addEventListener('fetch', function(event) {
  ...
  event.respondWith((async function() {
    ...
    Hlasem
      ...
      const tasksCss = `<style id="tasks-inline-v25">\n#panel-ukoly>.card{padding:18px!important;border-radius:18px!important}\n#panel-ukoly .todo-add{display:flex!important;gap:10px!important;margin-bottom:14px!important}\n#panel-ukoly .todo-add .fi{height:48px!important;font-size:16px!important;border-radius:14px!important}\n#panel-ukoly .todo-add .btn-p{width:48px!important;min-width:48px!important;height:48px!important;border-radius:14px!important;padding:0!important}\n#panel-ukoly .todo-add + div{display:flex!important;align-items:center!important;gap:7px!important;flex-wrap:nowrap!important;overflow-x:auto!important;overflow-y:hidden!important;margin:0 0 12px!important;padding:2px 1px 5px!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important}\n#panel-ukoly .todo-add + div::-webkit-scrollbar{display:none!important}\n#panel-ukoly .todo-add + div .todo-qd{flex:0 0 auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;height:38px!important;padding:0 14px!important;border-radius:999px!important;border:1px solid var(--border)!important;background:var(--surface-2)!important;color:var(--text-2)!important;font-size:12px!important;font-weight:700!important;white-space:nowrap!important}\n#panel-ukoly .todo-add + div .todo-qd.active{background:var(--accent)!important;border-color:var(--accent)!important;color:#fff!important;box-shadow:0 3px 10px rgba(99,102,241,.18)!important}\n#panel-ukoly .todo-add + div .todo-qd[data-val="other"]{font-size:0!important}\n#panel-ukoly .todo-add + div .todo-qd[data-val="other"]:after{content:'Více';font-size:12px!important}\n#panel-ukoly .todo-add + div + div{display:flex!important;align-items:center!important;gap:7px!important;flex-wrap:nowrap!important;overflow-x:auto!important;margin:0!important;scrollbar-width:none!important}\n#panel-ukoly .todo-add + div + div::-webkit-scrollbar{display:none!important}\n#panel-ukoly .todo-add + div + div .todo-qw{flex:0 0 auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;height:36px!important;padding:0 14px!important;border-radius:999px!important;border:1px solid var(--border)!important;background:var(--surface)!important;color:var(--text-2)!important;font-size:12px!important;font-weight:700!important;white-space:nowrap!important}\n#panel-ukoly .todo-add + div + div .todo-qw.active{background:var(--accent-soft)!important;border-color:#C7D2FE!important;color:var(--accent-hover)!important}\n#panel-ukoly #todo-list{margin-top:18px!important}\n#panel-ukoly #todo-list .todo-item{padding:12px 4px!important;min-height:52px!important}\n#panel-ukoly #todo-list .todo-check{width:24px!important;height:24px!important;min-width:24px!important;border-radius:7px!important}\n@media(max-width:600px){#panel-ukoly>.card{padding:16px!important}#panel-ukoly .todo-add + div .todo-qd{height:38px!important;padding:0 13px!important}#panel-ukoly .todo-add + div + div .todo-qw{height:36px!important;padding:0 13px!important}}\n</style>`;
      if (!html.includes('id="tasks-inline-v25"')) html = html.replace('</head>', tasksCss + '</head>');

      const quickScript = '<script src="/dashboard-enhancements.js?v=20260819-4"></script>';
      if (!html.includes('/dashboard-enhancements.js')) html = html.replace('</body>', quickScript + '</body>');

      const tasksScript = '<script src="/tasks-fix.js?v=20260819-2"></script>';
      if (!html.includes('/tasks-fix.js')) html = html.replace('</body>', tasksScript + '</body>');
